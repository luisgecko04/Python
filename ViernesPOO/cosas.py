...
class Profesor(Persona):
    ...
    def __str__(self):
        return Alumno.__str__() + f", Numero de trabajador: {self.__numero_trabajador}, Area: {self.__area}"
...
def __str__(self):
    return Alumno.__str__(self) + str{self.numero_trabajador} + self.area + f"Horas de " {self.__horas}"
